...
SELECT 
    ...
    SUM(CASE WHEN G1.ID IN ('230', '210', '215') THEN DR.VALOR_PAGAMENTO ELSE 0 END) AS 'C4 Despesas com Pessoal Terceirizado',
    SUM(CASE WHEN G1.ID IN ('234') THEN DR.VALOR_PAGAMENTO ELSE 0 END) AS 'C5 Despesas Operacionais com Shows',
    ...
    SUM(CASE WHEN G1.ID IN ('213', '229', '228', '212', '214', '219') THEN DR.VALOR_PAGAMENTO ELSE 0 END) AS 'C9 Despesas Financeiras',
...
SELECT
    CASE 
        ...
        WHEN G1.ID IN ('234') THEN 'c5_Despesas_Operacionais_com_Shows'
